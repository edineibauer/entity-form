            ...
            <div class="row">
                ...
                <div class="col s12 m6">
                    <div class="switch col s12">
                        <input type="checkbox" ng-disabled="attr.unique || attr.type == 'pri' || attr.type == 'extend' || attr.type == 'extend_mult' || attr.type == 'list_mult'" id="null" ng-model="attr.null"/>
                        <label for="null">Nulo</label>
                    </div>
                    <div class="switch col s12">
                        <input type="checkbox" ng-disabled="attr.null || attr.type == 'pri' || attr.type == 'extend' || attr.type == 'list' || attr.type == 'extend_mult' || attr.type == 'list_mult'" id="unique" ng-model="attr.unique"/>
                        <label for="unique">Unico</label>
                    </div>
                    <div class="switch col s12">
                        <input type="checkbox" ng-disabled="attr.type == 'pri' || attr.type == 'extend_mult' || attr.type == 'list_mult'" id="indice" ng-model="attr.indice"/>
